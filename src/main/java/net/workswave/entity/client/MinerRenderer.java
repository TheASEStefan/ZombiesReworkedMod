...
public class MinerRenderer extends GeoEntityRenderer<MinerEntity> {
    ...
    public MinerRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new MinerModel());
        shadowRadius = 0.5f;
    }
    ...
    @Override
    public void renderRecursively(PoseStack stack, MinerEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource multiBufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
