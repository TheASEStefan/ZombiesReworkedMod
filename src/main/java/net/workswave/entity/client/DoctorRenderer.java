...
public class DoctorRenderer extends GeoEntityRenderer<DoctorEntity> {
    ...
    public DoctorRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new DoctorModel());
        shadowRadius = 0.5f;
    }

    @Override
    public void preRender(PoseStack poseStack, DoctorEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
    ...
    @Override
    public void renderRecursively(PoseStack stack, DoctorEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource multiBufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
