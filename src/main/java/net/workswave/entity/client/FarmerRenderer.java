...
public class FarmerRenderer extends GeoEntityRenderer<FarmerEntity> {
    ...
    public FarmerRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new FarmerModel());
        shadowRadius = 0.5f;
    }

    @Override
    public void preRender(PoseStack poseStack, FarmerEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
    ...
    @Override
    public void renderRecursively(PoseStack stack, FarmerEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource multiBufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
