...
public class FirefighterEntity extends RottedZombie implements GeoEntity {
    ...
    public FirefighterEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, RottedConfig.SERVER.firefighter_health.get())
                .add(Attributes.ATTACK_DAMAGE, RottedConfig.SERVER.firefighter_damage.get())
